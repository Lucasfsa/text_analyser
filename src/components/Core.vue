...
function sendSimplePhrase(){

  if(phrases.value == null){
    alert("Campo obrigatório")
  }else{
    axiosInstance.post("/sentiment", {
...
function sendMultiplePhrases(){
    if(phrases.value == null){
      alert("Campo obrigatório")
    }else{
      axiosInstance.post("/process-sentiments", {
      "pre_processed_text": phrases.value 
      })
      .then(function(response){
    ...
    <div class="col-sm-6 div-intro">
      <div>
        ...
        <div  class="intro-body">
          <h3>
          Esta é uma ferramenta que tem a capacidade de analisar sentimentos textuais. O seu objetivo é analisar um texto, e através das palavras chaves identificadas, conseguir classificar a emoção presente no texto.
        </h3>
        <h3>
    ...
    <div class="col-sm-6">
          <div v-if="typeForm === 'simple'">
            <div class="simple-form">
              ...
              <div class="input-group  size-input mt-3">
                ...
                <input v-model="phrases" type="text" class="form-control" placeholder="Digite o texto..." aria-label="Usuário" >
              </div>
            ...
            <div class="simple-response mt-2">
              <div class="d-flex justify-content-center default-response" v-if="simplePhraseResponse == null">
          ...
          <div v-else-if="typeForm === 'multiple'">
              ...
              <div class="input-group mt-2">
                ...
                <textarea v-model="phrases" type="text" class="form-control" placeholder="Digite os textos..." aria-label="Usuário" ></textarea>
              </div>
            ...
            <div class="simple-response mt-2">
              <div class="d-flex justify-content-center default-response" v-if="multiplePhraseResponse == null">
                <svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"/></svg>              </div>
                <div v-else class="table-wrapper-scroll-y my-custom-scrollbar">
                  <div class="d-flex justify-content-center mb-2">
                    <h3>Estastísticas</h3>
